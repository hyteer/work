 ...
 * 
 */
@WebServiceClient(name = "CalWS", targetNamespace = "http://cal.me.org/", wsdlLocation = "http://localhost:8080/CalWS/CalWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALWS_QNAME = new QName("http://cal.me.org/", "CalWS");
    ...
    public CalWS getCalWSPort() {
        return super.getPort(new QName("http://cal.me.org/", "CalWSPort"), CalWS.class);
    }
    ...
    public CalWS getCalWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://cal.me.org/", "CalWSPort"), CalWS.class, features);
    }
